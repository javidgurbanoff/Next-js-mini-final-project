...
<div className="bg-white dark:bg-gray-900">
    <div className="container px-6 py-8 mx-auto">
        <h1 className="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">Simple pricing plan</h1>

        <p className="max-w-2xl mx-auto mt-4 text-center text-gray-500 xl:mt-6 dark:text-gray-300">
        The free version of the plan is much better than Standard and Pro 😉
        </p>
        ...
        <div className="grid grid-cols-1 gap-8 mt-6 lg:grid-cols-3 xl:mt-12">
            ...
            <div className="flex items-center justify-between px-8 py-4 border border-blue-500 cursor-pointer rounded-xl">
                <div className="flex flex-col items-center space-y-1">
                    ...
                    <h2 className="text-lg font-medium text-gray-700 sm:text-xl dark:text-gray-200">Standard</h2>
                </div>
        ...
        <div className="flex justify-center mt-8">
            <button popoverTarget="confirm" className="px-8 py-2 tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80">
              <a href="">
                Choose Plan
                </a>
            </button>
